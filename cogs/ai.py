...
#######################################################################
    ...
    async def on_message(self, msg):
        ...
        if self.bot.user not in msg.mentions:
            return
### Uncomment if you want to lock behind boosts again
...
### Uncomment when we switch back to gpt-4-vision-preview
...
#    @commands.has_role('Offerings to The Entity')
    ...
    async def imagine(self, ctx):
        ...
        if(phrase != None):
            ...
            print("Attempting gen...")
            generation = openai.images.generate(
                model='dall-e-3',
                prompt = phrase,
                size = "1024x1024",
                quality='standard',
